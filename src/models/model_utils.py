...
from models.centernet3d import CenterNet3D


def create_model(configs):
    """Create model based on architecture name"""

    if 'centernet3d' in configs.arch:
        model = CenterNet3D(configs.sparse_shape, configs.heads, configs.head_conv, configs.num_input_features)
    else:
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='CenterNet3D Implementation')
